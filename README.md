...
Bundled placeholder art is generated by
[`scripts/gen-placeholders.mjs`](scripts/gen-placeholders.mjs) — re-run with
`npm run gen:placeholders`. The owner's original `public/profile.jpg` is kept for
reference (low-res).
